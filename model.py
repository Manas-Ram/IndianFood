...
def get_nut_value(food, quantity): 
    ...
    #     return "Calories " + int(quantity)*dosa(0)  + "Carbs " + int(quantity)*dosa(1) + "Fats " + int(quantity)*dosa(2) + "Protein " + int(quantity)*dosa(3) + "Sodium " + int(quantity)*dosa(4)
    # elif food.lower=="uttapam":
    #     return "Calories " + int(quantity)*uttapam(0)  + "Carbs " + int(quantity)*uttapam(1) + "Fats " + int(quantity)*uttapam(2) + "Protein " + int(quantity)*uttapam(3) + "Sodium " + int(quantity)*uttapam(4)
    # elif food.lower=="idli":
    #     return "Calories " + int(quantity)*idli(0)  + "Carbs " + int(quantity)*idli(1) + "Fats " + int(quantity)*idli(2) + "Protein " + int(quantity)*idli(3) + "Sodium " + int(quantity)*idli(4)
    # elif food.lower=="basmati":
    #     return "Calories " + int(quantity)*basmati(0)  + "Carbs " + int(quantity)*basmati(1) + "Fats " + int(quantity)*basmati(2) + "Protein " + int(quantity)*basmati(3) + "Sodium " + int(quantity)*basmati(4)
    else:
        return "We have failed again!!!!"
        #return "Calories " + str(int(quantity)*biryani[0])  + "Carbs " + str(int(quantity)*biryani[1]) + "Fats " + str(int(quantity)*biryani[2]) + "Protein " + str(int(quantity)*biryani[3]) + "Sodium " + str(int(quantity)*biryani[4])
        #print("Calories " + int(quantity)*biryani(0)  + "Carbs " + int(quantity)*biryani(1) + "Fats " + int(quantity)*biryani(2) + "Protein " + int(quantity)*biryani(3) + "Sodium " + int(quantity)*biryani(4))